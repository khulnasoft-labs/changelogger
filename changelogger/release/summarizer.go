...
type Summarizer interface {
	...
	// ReferenceURL is the URL to find more information about this release, e.g. https://github.com/khulnasoft-labs/changelogger/releases/tag/v0.4.1 .
	ReferenceURL(tag string) string

	// ChangesURL is the URL to find the specific source changes that makeup this release, e.g. https://github.com/khulnasoft-labs/changelogger/compare/v0.3.0...v0.4.1 .
