...
import (
	...
	"github.com/khulnasoft-labs/changelogger/internal"
	"github.com/khulnasoft-labs/changelogger/internal/git"
...
func extractGithubUserAndRepo(u string) (string, string) {
	switch {
	// e.g. git@github.com:khulnasoft-labs/changelogger.git
	...
	// https://github.com/khulnasoft-labs/changelogger.git
